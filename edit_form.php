...
class evaluation_edit_use_template_form extends moodleform {
    ...
    public function definition() {
        ...
        $elementgroup = array();
        //headline
        $mform->addElement('header', 'using_templates', get_string('using_templates', 'evaluation'));
        // hidden elements
        ...
        $owntemplates = evaluation_get_template_list($course, 'own');
        $publictemplates = evaluation_get_template_list($course, 'public');
        ...
        if ($owntemplates or $publictemplates) {
            ...
            if ($publictemplates) {
                ...
                $options[get_string('public', 'evaluation')] = $publicoptions;
            }
            ...
            $mform->addElement('static', 'info', get_string('no_templates_available_yet', 'evaluation'));
        }
...
class evaluation_edit_create_template_form extends moodleform {
    ...
    public function definition() {
        ...
        //headline
        $mform->addElement('header', 'creating_templates', get_string('creating_templates', 'evaluation'));
    ...
    public function validation($data, $files) {
        ...
        if (!isset($data['templatename']) || trim(strval($data['templatename'])) === '') {
            $errors['elementgroup'] = get_string('name_required', 'evaluation');
        }
        return $errors;
    }
}
