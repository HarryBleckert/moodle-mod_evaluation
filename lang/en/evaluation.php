...
$string['automaticreminders'] = 'Automatically mail reminders';
$string['automaticreminders_desc'] = 'At the start of the evaluation, every 2 weeks, 4 days before the end of the evaluation.';
...
$string['no_permission_analysis'] = 'You do not have the permisssions required to view this analysis!';
$string['no_respnses_yet'] = "No evaluations received!";
