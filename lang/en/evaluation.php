...
// send reminders
$string['sent_reminders_info'] = 'Info mails sent to {$a->mails_sent} {$a->role}';
...
$string['send_reminders_pmsg'] = 'Today, emails with information about the ongoing evaluation were sent to {$a->mails_sent} {$a->role}, whose courses are taking part in the evaluation.<br>See the <b>example</b> mail below';
...
$string['viewanddownload'] = 'view and download if at least {$a->minresultspriv} submissions have been provided.';
...
$string['reminders_title'] = 'Reminder mails can be sent by admins or as a scheduled server task only. The note \'NR\' indicates that only students without submissions or lecturers with fewer than {$a->min_results_text} submissions (non-responders) were contacted.';
...
$string['drop_evaluation'] = 'Remove from this course';
$string['edit_item'] = 'Edit questionaire element';
$string['edit_items'] = 'Edit questionaire';
...
$string['ev_end_msg'] = 'Evaluation period ends {$a->ev_end_msg}';
