...
$string['change_sort_by'] = 'Sortierung nach Abgaben oder nach Mittelwerten';
...
$string['evaluated_results'] = '{$a->displayed_results}/{$a->evaluation_results} ausgewertete {$a->allSubject} {$a->percentage}';
//$string[''] = '';
// $string[''] = '';
...
$string['reminders_title'] = 'Hinweismails können nur von Admins oder als geplanter Server Task versandt werden. Der Vermerk \'NR\' weist darauf hin, dass nur Studierende ohne Abgaben bzw. Dozent_innen mit weniger als {$a->min_results_text} Abgaben (Non-Responders) angeschrieben wurden.';
...
$string['edit_item'] = 'Fragebogen Element bearbeiten';
$string['edit_items'] = 'Fragebogen bearbeiten';
...
$string['show_entries'] = 'Rohdaten';
$string['show_entry'] = 'Abgabe anzeigen';
