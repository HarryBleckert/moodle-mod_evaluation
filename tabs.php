...
if ( isset($teacherid) AND $teacherid ) {	$urlparams['teacherid'] = $teacherid; }
elseif ( isset($teacheridSaved ) ) {	$urlparams['teacherid'] = $teacheridSaved; }
if ( isset($course_of_studiesID) AND $course_of_studiesID ) {	$urlparams['course_of_studiesID'] = $course_of_studiesID; }
...
if ( $isTeacher )
{ $can_view = true; }
elseif ( !$is_open AND $evaluation->timeclose<time() AND $evaluation->publish_stats )
...
{	if ( $courseid ) {	$urlparamsIDT['courseid'] = $courseid; }
	if ( $isTeacher )	{	$urlparamsIDT['teacherid'] = $USER->id; }
	if ( defined('EVALUATION_OWNER') )
	{ if ( $teacherid )	{	$urlparamsIDT['teacherid'] = $teacherid; }
	  if ( $course_of_studiesID )	{	$urlparamsIDT['course_of_studiesID'] = $course_of_studiesID; }
	}
