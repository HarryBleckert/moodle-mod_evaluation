...
/**
 * Unit tests for (some of) mod/evaluation/classes/lib.php.
 *
...
global $CFG;
require_once($CFG->dirroot . '/mod/evaluation/classes/completion.php');

/**
 * Unit tests for (some of) mod/evaluation/classes/completion.php.
 *
 * @copyright  2019 Tobias Reischmann
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
