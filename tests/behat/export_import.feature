@mod @mod_evaluation
Feature: Exporting and importing evaluations
  In order to quickly copy evaluations across courses and sites
  As a teacher
  I need to be able to export and import evaluations
  ...
  Scenario: Export sample evaluation and compare with the fixture
    ...
    Then following "Export questions" should export evaluation identical to "mod/evaluation/tests/fixtures/testexport.xml"
    And I log out

  @javascript @_file_upload
  Scenario: Import evaluation deleting old items
    When I log in as "teacher"
    And I am on "Course 1" course homepage
    And I follow "Learning experience"
    And I click on "Edit questions" "link" in the "[role=main]" "css_element"
    ...
    And I upload "mod/evaluation/tests/fixtures/testexport.xml" file to "File" filemanager
    And I press "Yes"
    And I click on "Edit questions" "link" in the "[role=main]" "css_element"
  ...
  @javascript @_file_upload
  Scenario: Import evaluation appending new items
    When I log in as "teacher"
    And I am on "Course 1" course homepage
    And I follow "Learning experience"
    And I click on "Edit questions" "link" in the "[role=main]" "css_element"
