@mod @mod_evaluation
Feature: Test creating different types of evaluation questions for anonymous evaluation
  In order to create evaluations
  As a teacher
  I need to be able to add different question types

  @javascript
  Scenario: Create different types of questions in anonymous evaluation with javascript enabled
