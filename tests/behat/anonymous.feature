@mod @mod_evaluation
Feature: Anonymous evaluation
  In order to collect evaluations
  As an admin
  I need to be able to allow anonymous evaluations
  ...
  Background:
    ...
    And the following "activities" exist:
      ...
      | evaluation   | Site evaluation   | Acceptance test site | evaluation0 | 1         | 1             | 1       |
      | evaluation   | Course evaluation | C1                   | evaluation1 | 1         | 1             | 0       |
  ...
  Scenario: Guests can see anonymous evaluation on front page but can not complete
    When I follow "Site evaluation"
    Then I should not see "Answer the questions"
    And I follow "Preview"
    And I should see "Do you like our site?"
    And I press "Continue"

  Scenario: Complete anonymous evaluation on the front page as an authenticated user
  ...
  @javascript
  Scenario: Complete anonymous evaluation and view analysis on the front page as an authenticated user
    And I log in as "admin"
    And I set the following system permissions of "Authenticated user on frontpage" role:
      | capability                   | permission |
      | mod/evaluation:viewanalysepage | Allow      |
    And I log out
    And I log in as "user1"
    And I am on site homepage
    When I follow "Site evaluation"
    ...
    # And I should not see "multichoice2" # TODO MDL-29303 do not show labels to users who can not edit evaluation
  ...
  Scenario: Complete fully anonymous evaluation on the front page as a guest
    And I log in as "admin"
    And I set the following administration settings values:
      | evaluation_allowfullanonymous | 1 |
    And I log out
    When I follow "Site evaluation"
    And I follow "Preview"
    And I should see "Do you like our site?"
  ...
  @javascript
  Scenario: Complete fully anonymous evaluation and view analyze on the front page as a guest
    And I log in as "admin"
    And I set the following administration settings values:
      | evaluation_allowfullanonymous | 1 |
  ...
  @javascript
  Scenario: Anonymous evaluation in a course
    # Teacher can not
  ...
  Scenario: Collecting new non-anonymous evaluation from a previously anonymous evaluation activity
    When I log in as "teacher"
    And I am on "Course 1" course homepage
    And I follow "Course evaluation"
    ...
    And I press "Save and display"
    And I log out
    # Now leave a non-anon evaluation as user1
    When I log in as "user1"
    And I am on "Course 1" course homepage
    And I follow "Course evaluation"
    And I follow "Answer the questions"
