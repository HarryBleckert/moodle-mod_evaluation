@mod @mod_evaluation
Feature: Saving, using and deleting evaluation templates
  In order to quickly create evaluations
  As a manager
  I need to be able to create evaluation templates
  ...
  Background:
    ...
    And the following "activities" exist:
      ...
      | evaluation   | Learning experience course 1 | C1     | evaluation1   |
      | evaluation   | Another evaluation in course 1 | C1     | evaluation2   |
      | evaluation   | Learning experience course 2 | C2     | evaluation3   |
  ...
  Scenario: Teacher can save template and re-use it in the same course only
    # Go to evaluation templates and make sure none exist yet
    ...
    # Create a evaluation from this template in the same course
    And I am on "Course 1" course homepage
    And I follow "Another evaluation in course 1"
    And I follow "Templates"
  ...
  Scenario: Teacher can append template to existing questions or remove them
    # Save evaluation as a course template
    When I log in as "teacher"
    And I am on "Course 1" course homepage
    And I follow "Learning experience course 1"
    And I follow "Templates"
    And I set the field "Name" to "My first template"
    And I press "Save as new template"
    # Add questions to another evaluation
    And I am on "Course 1" course homepage
    And I follow "Another evaluation in course 1"
    And I click on "Edit questions" "link" in the "[role=main]" "css_element"
    And I add a "Multiple choice" question to the evaluation with:
  ...
  Scenario: Teacher can delete course templates but can not delete public templates
    # Save evaluation as both public and course template
    When I log in as "manager"
    And I am on "Course 1" course homepage
    And I follow "Learning experience course 1"
    And I follow "Templates"
