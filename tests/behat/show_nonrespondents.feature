@mod @mod_evaluation
Feature: Show users who have not responded to the evaluation survey
  In order to harass students about completing the evaluation
  As a teacher
  ...
  Scenario: See users who have not responded
    ...
    And I add a "Evaluation" to section "1" and I fill the form with:
      | Name                | Frogs                                             |
      | Description         | x                                                 |
    ...
    # Go in as student 1 and do the evaluation.
