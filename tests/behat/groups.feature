@mod @mod_evaluation
Feature: Evaluations in courses with groups
  In order to collect evaluations per group
  As an teacher
  I need to be able to filter evaluation replies by groups
  ...
  Background:
    ...
    And the following "activities" exist:
      ...
      | evaluation   | Site evaluation   | Acceptance test site | evaluation0 | 2         | 1             | 1         | 1       |
      | evaluation   | Course evaluation | C1                   | evaluation1 | 2         | 1             | 1         | 0       |
      | evaluation   | Course anon evaluation | C1              | evaluation2 | 1         | 1             | 1         | 0       |
    When I log in as "manager"
    And I am on site homepage
    And I follow "Site evaluation"
  ...
  @javascript
  Scenario: Non anonymous evaluation with groups in a course
    ...
    And I add a "Multiple choice" question to the evaluation with:
      ...
      | Multiple choice values         | Yes of course\nNot at all\nI don't know |
    And I log out
    And I log in as "user1" and complete evaluation "Course evaluation" in course "Course 1" with:
      | Not at all | 1 |
    And I log in as "user2" and complete evaluation "Course evaluation" in course "Course 1" with:
      | I don't know | 1 |
    And I log in as "user3" and complete evaluation "Course evaluation" in course "Course 1" with:
      | Not at all | 1 |
    And I log in as "user4" and complete evaluation "Course evaluation" in course "Course 1" with:
      | Yes of course | 1 |
    And I log in as "user5" and complete evaluation "Course evaluation" in course "Course 1" with:
      | Yes of course | 1 |
    And I log in as "user6" and complete evaluation "Course evaluation" in course "Course 1" with:
      | Not at all | 1 |
    And I log in as "user7" and complete evaluation "Course evaluation" in course "Course 1" with:
      | I don't know | 1 |
    ...
    And I show chart data for the "multichoice1" evaluation
  ...
  @javascript
  Scenario: Anonymous evaluation with groups in a course
    When I log in as "teacher"
    And I am on "Course 1" course homepage
    And I follow "Course anon evaluation"
    And I click on "Edit questions" "link" in the "[role=main]" "css_element"
    And I add a "Multiple choice" question to the evaluation with:
      | Question                       | Do you like this course?           |
      | Label                          | multichoice1                       |
      ...
      | Multiple choice values         | Yes of course\nNot at all\nI don't know |
    And I log out
    And I log in as "user1" and complete evaluation "Course anon evaluation" in course "Course 1" with:
      | Not at all | 1 |
    And I log in as "user1"
    And I am on "Course 1" course homepage
    And I follow "Course anon evaluation"
    ...
    And I log out
    And I log in as "user2" and complete evaluation "Course anon evaluation" in course "Course 1" with:
      | I don't know | 1 |
    And I log in as "user3" and complete evaluation "Course anon evaluation" in course "Course 1" with:
      | Not at all | 1 |
    And I log in as "user4" and complete evaluation "Course anon evaluation" in course "Course 1" with:
      | Yes of course | 1 |
    And I log in as "user5" and complete evaluation "Course anon evaluation" in course "Course 1" with:
      | Yes of course | 1 |
    And I log in as "user6" and complete evaluation "Course anon evaluation" in course "Course 1" with:
      | Not at all | 1 |
    And I log in as "user7" and complete evaluation "Course anon evaluation" in course "Course 1" with:
      | I don't know | 1 |
    # View analysis, user1 should only see one group - group 1
    And I log in as "user1"
    And I am on "Course 1" course homepage
