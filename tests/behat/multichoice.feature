@mod @mod_evaluation
Feature: Testing multichoice questions in evaluation
  In order to create evaluations
  As a teacher
  ...
  Background:
    ...
    And the following "activities" exist:
      ...
      | evaluation   | Learning experience | C1     | evaluation0   |
  ...
  @javascript
  Scenario: Non-rated single-answer multiple choice questions in evaluation
    When I add a "Multiple choice" question to the evaluation with:
      | Question         | this is a multiple choice 1 |
      | Label            | multichoice1                |
      | Multiple choice type | Multiple choice - single answer |
      | Multiple choice values | option a\noption b\noption c  |
    And I add a "Label" question to the evaluation with:
      | Contents | this is the first page of the evaluation |
    ...
    And I add a "Multiple choice" question to the evaluation with:
      ...
      | Required | 1 |
    And I add a "Label" question to the evaluation with:
      | Contents | this is the second page of the evaluation |
    And I select "Add a page break" from the "Add question" singleselect
    And I add a "Multiple choice" question to the evaluation with:
    ...
    And I add a "Label" question to the evaluation with:
      | Contents | this is the third page of the evaluation |
    And I log out
    ...
    And I should see "this is the first page of the evaluation"
    And I should not see "this is the second page of the evaluation"
    And I should not see "this is the third page of the evaluation"
    ...
    And "Submit your answers" "button" should not exist
    And I should not see "this is the first page of the evaluation"
    And I should see "this is the second page of the evaluation"
    And I should not see "this is the third page of the evaluation"
    And I press "Next page"
    ...
    And I should see "this is the third page of the evaluation"
    ...
    And I show chart data for the "multichoice2" evaluation
    ...
    And I show chart data for the "multichoice3" evaluation
    ...
    And I click on "Edit questions" "link" in the "[role=main]" "css_element"
    And I open the action menu in "//div[contains(@class, 'evaluation_itemlist') and contains(.,'multichoice1')]" "xpath_element"
  ...
  @javascript
  Scenario: Non-rated multiple-answers multiple choice questions in evaluation
    # Create a evaluation with three pages, required and dependent questions.
    When I add a "Multiple choice" question to the evaluation with:
      | Question         | this is a multiple choice 1 |
      | Label            | multichoice1                |
  ...
  @javascript
  Scenario: Non-rated single-answer dropdown multiple choice questions in evaluation
    When I add a "Multiple choice" question to the evaluation with:
      | Question         | this is a multiple choice 1 |
      | Label            | multichoice1                |
