@mod @mod_evaluation
Feature: Test creating different types of evaluation questions for non-anonymous evaluation
  In order to create evaluations
  As a teacher
  I need to be able to add different question types

  @javascript
  Scenario: Create different types of questions in non-anonymous evaluation with javascript enabled
    ...
    And the following "activities" exist:
      ...
      | evaluation   | Learning experience | C1     | evaluation0   | 2         |
    ...
    And I add a "Label" question to the evaluation with:
      | Contents | label text |
    And I add a "Longer text answer" question to the evaluation with:
    ...
    And I add a "Numeric answer" question to the evaluation with:
    ...
    And I follow "Answer the questions"
    And I set the following fields to these values:
      | this is a longer text answer | lots of evaluations |
      | option a                     | 1              |
      | option d                     | 1              |
      | option e                     | 1              |
    ...
    And I should see "lots of evaluations" in the "(longertext)" "table"
    ...
    And I show chart data for the "multichoice4" evaluation
