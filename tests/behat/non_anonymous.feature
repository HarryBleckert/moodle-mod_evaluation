@mod @mod_evaluation
Feature: Non anonymous evaluation
  In order to collect evaluations
  As an teacher
  I need to be able to create and collect evaluations
  ...
  Background:
    ...
    And the following "activities" exist:
      ...
      | evaluation   | Site evaluation   | Acceptance test site | evaluation0 | 2         | 1             | 1       |
      | evaluation   | Course evaluation | C1                   | evaluation1 | 2         | 1             | 0       |
  ...
  Scenario: Guests can see non anonymous evaluation on front page but can not complete
  ...
  Scenario: Complete non anonymous evaluation on the front page as an authenticated user
  ...
  @javascript
  Scenario: Complete non anonymous evaluation and view analysis on the front page as an authenticated user
  ...
  @javascript
  Scenario: Non anonymous evaluation in a course
