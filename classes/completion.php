...
class mod_evaluation_completion extends mod_evaluation_structure {
    ...
    public function trigger_module_viewed() {
        $event = \mod_evaluation\event\course_module_viewed::create_from_record($this->evaluation, $this->cm,
                $this->cm->get_course());
        $event->trigger();
    }
    ...
    public function process_page($gopage, $gopreviouspage = false) {
        ...
        if ($this->form->is_cancelled()) {    // Form was cancelled - return to the course page.
    ...
    public function find_last_completed() {
        ...
        } else if (isset($_SESSION['teacherid']) and $_SESSION['teacherid']) {
