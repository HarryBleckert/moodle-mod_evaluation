...
/**
 * Class for exporting a evaluation item (question).
 *
...
class evaluation_item_exporter extends exporter {
    ...
    protected function get_other_values(renderer_base $output) {
        ...
        $fs = get_file_storage();
        $files = array();
        $itemfiles = $fs->get_area_files($context->id, 'mod_evaluation', 'item', $this->data->id, 'filename', false);
        if (!empty($itemfiles)) {
