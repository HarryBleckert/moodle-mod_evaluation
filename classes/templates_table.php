...
/**
 * Contains class mod_evaluation_templates_table
 *
...
/**
 * Class mod_evaluation_templates_table
 *
 * @package   mod_evaluation
 * @copyright 2016 Marina Glancy
 * @license   http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class mod_evaluation_templates_table extends flexible_table {
    ...
    public function __construct($uniqueid, $baseurl) {
        ...
        $tableheaders = array(get_string('template', 'evaluation'), '');
    ...
    public function display($templates) {
        ...
        foreach ($templates as $template) {
            ...
            $deleteaction = new confirm_action(get_string('confirmdeletetemplate', 'evaluation'));
