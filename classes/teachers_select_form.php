 ...
 * @license   http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class mod_evaluation_teachers_select_form extends moodleform {
    /** @var moodle_url */
    protected $action;
    ...
    public function __construct($action, mod_evaluation_structure $evaluationstructure, $editable = true) {
        $this->action = new moodle_url($action, ['teacherid' => null]);
        $this->evaluationstructure = $evaluationstructure;
        parent::__construct($action, null, 'post', '', ['id' => 'evaluation_teacherid_filter'], $editable);
    }
    ...
    public function definition() {
        ...
        $this->set_data(['teacherid' => $evaluationstructure->get_teacherid(), 'id' => $evaluationstructure->get_cm()->id]);
    }
}
