YUI.add('moodle-mod_evaluation-dragdrop', function(Y) {
    var DRAGDROPNAME = 'mod_evaluation_dragdrop';
    var CSS = {
    ...
    Y.extend(DRAGDROP, M.core.dragdrop, {
        ...
        initializer : function(params) {
            ...
            var handletitle = M.util.get_string('move_item', 'evaluation');
        ...
        save_item_order : function(cmid, itemorder, spinner) {
            ...
            Y.io(M.cfg.wwwroot + '/mod/evaluation/ajax.php', {
    ...
    M.mod_evaluation = M.mod_evaluation || {};
    M.mod_evaluation.init_dragdrop = function(params) {
